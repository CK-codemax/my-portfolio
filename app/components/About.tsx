...
export default function About({}: Props) {
  return (
    ...
    transition={{
        ...
        <h3 className="absolute top-20 sm:top-8 uppercase tracking-[20px] text-gray-500 text-base sm:text-xl">About</h3>
        <motion.img 
        initial={{
            x : -200,
            opacity : 0,
       ...
       className='hidden sm:block md:mb-0 flex-shrink-0 w-56 h-56 rounded-full object-cover md:rounded-lg md:w-64 md:h-96 xl:w-[280px] xl:h-[420px]' src={'/ochuko.jpg'} alt='profile-image'/>
