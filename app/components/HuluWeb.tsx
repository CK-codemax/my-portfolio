...
export default function HuluWeb({}: Props) {
  return (
    <motion.div 
    initial={{
        opacity : 0,
    ...
    transition={{
     ...
     className="h-screen flex relative overflow-hidden flex-col text-left md:flex-row max-w-full px-10 justify-evenly mx-auto items-center">
         <h3 className="absolute top-20 sm:top-8 uppercase tracking-[20px] text-gray-500 text-base sm:text-xl">Hulu landing page</h3>
