  ...
  return (
    <header className="bg-gray-200 z-50 top-0 dark:bg-[#242424] h-[70px] w-full shadow-md sticky justify-between px-3 lg:px-7 flex items-center">
        ...
        transition={{
            ...
            <Link href={'/'} className="w-[50px] group h-[50px] cursor-pointer flex items-center justify-center rounded-full bg-transparent hover:bg-gray-500 dark:hover:bg-gray-200 transition-all duration-300 ease-in-out">
