...
export default function Skill({percentage, src, name, directionLeft}: Props) {
  return (
    <div className="group relative flex lg:flex-col lg:space-y-2 items-center justify-center cursor-pointer">
        ...
        <div className="absolute top-0 lg:translate-x-1 lg:-translate-y-2 left-0 opacity-0 group-hover:opacity-80 transition duration-300 ease-in-out group-hover:bg-red-500 dark:group-hover:bg-white w-[75px] h-[75px] sm:w-28 sm:h-28 lg:h-32 lg:w-32 rounded-full z-0">
